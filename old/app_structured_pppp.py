...
st.set_page_config(page_title="MP-Agent: Объективный тренажёр", page_icon="🧠")

# === Выбор файла сценариев ===
scenarios_file = st.selectbox("Выберите набор сценариев:", [
    "scenarios_structured.json",
    "scenarios_structured_PPPP.json"
])
...
# === Заголовок ===
st.title("🧠 Тренажёр по отработке возражений (структура ПППП)")
